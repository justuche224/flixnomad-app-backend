...
const Page = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await axios.get("/api/movies/not-trending");
          ...
          >
            ...
            <div className="pt-2">
              <button
                ...
                className="bg-green-500 px-2 py-1 rounded hover:bg-green-600 hover:rounded-sm duration-300 cursor-pointer"
              >
                Add Trending
              </button>
            </div>
